...
public class FindCat extends JFrame
{
  ...
  JLabel[] choiceLabel = new JLabel[8];
  ImageIcon cat = new ImageIcon("realTreasure.jpg");
  ...
  {
    // frame constructor
    setTitle("Find the Chicken-Created by Mr. Warner: November 2018");
    setResizable(false);
  ...
  private void labelMouseClicked(MouseEvent e)
  {
    ...
    int choice;
    for (choice = 0; choice < rowColNum; choice++)
    {
  ...
  private void newButtonActionPerformed(ActionEvent e)
  {
    ...
    catLocation = myRandom.nextInt(rowColNum);
